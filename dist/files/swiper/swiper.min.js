(function() {
        ...
        for (let s = 1; s < e.length; s += 1) {
            ...
            if (null != a && !p(a)) {
                ...
                for (let s = 0, i = e.length; s < i; s += 1) {
                    const i = e[s], r = Object.getOwnPropertyDescriptor(a, i);
    ...
    var H = {
        ...
        updateSlides: function() {
            ...
            m(a, "--swiper-centered-offset-after", "")), s.cssMode && (m(a, "--swiper-slides-offset-before", `${f}px`), 
            ...
            P && e.grid.updateWrapperSize(L, p), !s.centeredSlides) {
                const t = "auto" !== s.slidesPerView && s.slidesPerView % 1 != 0, a = s.snapToSlideEdge && !s.loop && ("auto" === s.slidesPerView || t);
                let i = p.length;
                if (a) {
                    let e;
        ...
        updateActiveIndex: function(e) {
            ...
            let u;
            if (t.virtual && i.virtual.enabled) u = i.loop ? c(d) : d; else if (p) {
    ...
    var q = {
        loopCreate: function(e, t) {
            ...
            if (o) {
                ...
                if (a.loopAddBlankSlides) c(a.grid.rows - s.slides.length % a.grid.rows), s.recalcSlides(), 
                s.updateSlides(); else v("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");
                r();
            } else r();
    ...
    const be = [ function({swiper: e, extendParams: t, on: s, emit: i}) {
        ...
        function o(t) {
            ...
            ((c || u) && !s || (d || p) && s) && e.slideNext(f), ((d || p) && !s || (c || u) && s) && e.slidePrev(f)) : ((d || c || m || h) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), 
            (c || h) && e.slideNext(f), (d || m) && e.slidePrev(f)), i("keyPress", r);
        }
        function d() {
        ...
        function C() {
            ...
            i && (l = i.querySelector(de(e.params.scrollbar.dragClass)), l || (l = w("div", e.params.scrollbar.dragClass), 
        ...
        function z(t) {
            ...
            f.minX = Math.min(h.slideWidth / 2 - i / 2, 0), f.maxX = -f.minX, f.minY = Math.min(h.slideHeight / 2 - r / 2, 0), 
        ...
        function k(t) {
            ...
            h.maxRatio = S(), e.params.cssMode && (e.wrapperEl.style.overflow = "hidden", e.wrapperEl.style.touchAction = "none"), 
        ...
        function O() {
            ...
            h.imageEl && h.imageWrapEl && (h.maxRatio = S(), e.params.cssMode && (e.wrapperEl.style.overflow = "", 
        ...
        t({
            ...
            if ("undefined" != typeof window && ("string" == typeof e.params.controller.control || e.params.controller.control instanceof HTMLElement)) return void ("string" == typeof e.params.controller.control ? [ ...document.querySelectorAll(e.params.controller.control) ] : [ e.params.controller.control ]).forEach(t => {
        ...
        const y = (e, t, s) => {
            ...
            r = s;
            const a = e.virtual && e.params.virtual.enabled, n = (a ? parseInt(s.getAttribute("data-swiper-slide-index"), 10) : e.slides.indexOf(s)) === e.activeIndex, o = e.params.watchSlidesProgress && e.visibleSlides && e.visibleSlides.includes(s);
            ...
            if (o = M(o), d = M(d), o && o.forEach(e => y(e, r, t.nextSlideMessage)), d && d.forEach(e => y(e, r, t.prevSlideMessage)), 
            ...
            e.el.addEventListener("pointerdown", x, !0), e.el.addEventListener("pointerup", S, !0);
        };
        s("beforeInit", () => {
            ...
            e.params.a11y.enabled && function() {
                ...
                v() && e.pagination.bullets.forEach(s => {
                    ...
                    m(s, t.paginationBulletMessage.replace(/\{\{index\}\}/, E(s) + 1)))), s.matches(de(e.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current");
                });
            }();
        }), s("destroy", () => {
            e.params.a11y.enabled && function() {
        ...
        const b = () => {
            ...
            const a = e.params.speed, r = () => {
                ...
                i("autoplay")), e.params.cssMode && (v = (new Date).getTime(), requestAnimationFrame(() => {
                    E();
                })));
            };
            ...
            o = r - ((new Date).getTime() - v), e.isEnd && o < 0 && !e.params.loop || (o < 0 && (o = 0), 
            a());
        }, M = () => {
            e.isEnd && o < 0 && !e.params.loop || e.destroyed || !e.autoplay.running || (v = (new Date).getTime(), 
            m ? (m = !1, E(o)) : E(), e.autoplay.paused = !1, i("autoplayResume"));
        }, C = () => {
            if (e.destroyed || !e.autoplay.running) return;
            const t = a();
        ...
        function o() {
            ...
            return e.thumbs.swiper.el.classList.add(e.params.thumbs.thumbsContainerClass), e.thumbs.swiper.on("tap", l), 
        ...
        function d(t, s) {
            ...
            e.params.thumbs.multipleActiveThumbs || (i = 1), i = Math.floor(i), a.slides.forEach(e => e.classList.remove(r)), 
            a.params.loop || n()) for (let t = 0; t < i; t += 1) g(a.slidesEl, `[data-swiper-slide-index="${e.realIndex + t}"]`).forEach(e => {
                e.classList.add(r);
            ...
            (s?.autoScroll ?? 1) && function(t) {
                ...
                if (e.realIndex !== s.realIndex || r) {
                    ...
                    r && (l += "next" === o ? i : -1 * i), s.visibleSlidesIndexes && s.visibleSlidesIndexes.indexOf(l) < 0 && (s.params.centeredSlides ? l = l > n ? l - Math.floor(a / 2) + 1 : l + Math.floor(a / 2) - 1 : l > n && s.params.slidesPerGroup, 
                    s.slideTo(l, t));
                }
            }(t ? 0 : void 0);
        }
        e.thumbs = {
            ...
            if (t && t.swiper) if ("string" == typeof t.swiper || t.swiper instanceof HTMLElement) {
                const s = a(), i = () => {
                    ...
                    if (a && a.swiper) t.swiper = a.swiper, o(), d(!0); else if (a) {
                        const s = `${e.params.eventsPrefix}init`, i = r => {
                            t.swiper = r.detail[0], a.removeEventListener(s, i), o(), d(!0), t.swiper.update(), 
                            e.update();
                        };
        ...
        t({
            ...
            setTranslate: () => {
                ...
                for (let s = 0; s < t.length; s += 1) {
                    ...
                    const r = e.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(t.progress), 0) : 1 + Math.min(Math.max(t.progress, -1), 0), n = ge(0, t);
        ...
        const a = (t, s) => {
            ...
            a || (a = we("flip", t, e.isHorizontal() ? "left" : "top")), i || (i = we("flip", t, e.isHorizontal() ? "right" : "bottom")), 
        ...
        t({
            ...
            setTranslate: () => {
                ...
                for (let e = 0, t = a.length; e < t; e += 1) {
                    ...
                    if (ge(0, t).style.transform = y, t.style.zIndex = 1 - Math.abs(Math.round(u)), 
                    r.slideShadows) {
                        ...
                        e || (e = we("coverflow", t, n ? "left" : "top")), s || (s = we("coverflow", t, n ? "right" : "bottom")), 
